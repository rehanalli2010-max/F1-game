...
export const TRANSLATIONS = {
  ...
  it: {
    ...
    nav_race_title: 'Gara Sprint (Griglia a 10 Vetture)',
    ...
    controls_guide: 'W A S D o Frecce per Guidare • R Ripristina • C Telecamera • Spazio Freno a mano',
    ...
    badge_race_grid: 'GARA SPRINT - GRIGLIA DI PARTENZA',
    badge_race_racing: 'GARA SPRINT',
    ...
    help_key_camera: 'Cambia Telecamera (Inseguimento / Abitacolo / TV)',
    ...
    quali_btn_race: 'Inizia Gara Sprint',
    quali_btn_practice: 'Torna alle Prove',

    // Race Finish Modal
    race_modal_title: 'GARA SPRINT COMPLETATA',
    ...
    mp_btn_launch: 'Avvia Gara Sprint Multigiocatore',
  ...
  en: {
    ...
    nav_race_title: 'Sprint Race (10-Car Grid)',
    ...
    controls_guide: 'W A S D or Arrow Keys to Drive • R Reset • C Camera • Space Handbrake',
    ...
    badge_race_grid: 'SPRINT RACE - START GRID',
    badge_race_racing: 'SPRINT RACE',
    ...
    help_secondary_actions: 'Secondary Actions & Camera',
    ...
    help_key_camera: 'Cycle Camera (Chase / Cockpit / TV)',
    ...
    quali_btn_race: 'Start Sprint Race',
    quali_btn_practice: 'Return to Practice',

    race_modal_title: 'SPRINT RACE FINISHED',
    ...
    mp_btn_launch: 'Launch Multiplayer Sprint Race',
  ...
  es: {
    ...
    nav_race_title: 'Carrera Sprint (Parrilla de 10 Coches)',
    ...
    controls_guide: 'W A S D o Flechas para Conducir • R Reiniciar • C Cámara • Espacio Freno de Mano',
    ...
    badge_race_grid: 'CARRERA SPRINT - PARRILLA DE SALIDA',
    badge_race_racing: 'CARRERA SPRINT',
    ...
    help_key_camera: 'Cambiar Cámara (Persecución / Cabina / TV)',
    help_key_drs: 'Alerón Trasero DRS',
    ...
    quali_btn_race: 'Iniciar Carrera Sprint',
    quali_btn_practice: 'Volver a Práctica',

    race_modal_title: 'CARRERA SPRINT FINALIZADA',
  ...
  fr: {
    ...
    nav_race_title: 'Course Sprint (Grille de 10 Voitures)',
    ...
    controls_guide: 'W A S D ou Flèches pour Conduire • R Réinitialiser • C Caméra • Espace Frein à main',
    ...
    badge_race_grid: 'COURSE SPRINT - GRILLE DE DÉPART',
    badge_race_racing: 'COURSE SPRINT',
    ...
    help_key_reset: 'Repositionner la Voiture',
    help_key_camera: 'Changer de Caméra (Poursuite / Cockpit / TV)',
    help_key_drs: 'Volet DRS Aileron Arrière',
    ...
    quali_btn_race: 'Démarrer la Course Sprint',
    quali_btn_practice: 'Retour aux Essais',

    race_modal_title: 'COURSE SPRINT TERMINÉE',
  ...
  de: {
    ...
    nav_race_title: 'Sprint-Rennen (10 Fahrzeuge)',
    ...
    controls_guide: 'W A S D oder Pfeiltasten zum Fahren • R Zurücksetzen • C Kamera • Leertaste Handbremse',
    ...
    badge_race_grid: 'SPRINT-RENNEN - STARTAUFSTELLUNG',
    badge_race_racing: 'SPRINT-RENNEN',
    ...
    help_key_camera: 'Kamera wechseln (Verfolgung / Cockpit / TV)',
    help_key_drs: 'DRS-Heckflügel umschalten',
    ...
    quali_btn_race: 'Sprint-Rennen starten',
    quali_btn_practice: 'Zurück zum Training',

    race_modal_title: 'SPRINT-RENNEN BEENDET',
  ...
  ja: {
    ...
    nav_race_title: 'スプリントレース（10台グリッド）',
    ...
    controls_guide: 'W A S D または矢印キーで走行 • R リセット • C カメラ切替 • Space サイドブレーキ',

    badge_practice_free: 'フリー走行 - フリー走行中',
    badge_practice_solo: 'フリー走行 - 単独走行',
    badge_quali_outlap: '予選 - アウトラップ',
    badge_quali_hotlap: '予選 - アタックラップ',
    badge_race_grid: 'スプリントレース - スターティンググリッド',
    badge_race_racing: 'スプリントレース',
    ...
    help_key_reset: 'マシンをコース上に復帰',
    help_key_camera: 'カメラ視点切替（チェイス/コクピット/TV）',
    help_key_drs: 'DRSリアウイング手動切替',
    ...
    quali_delta: 'ポールとの差',
    quali_btn_race: 'スプリントレース開始',
    quali_btn_practice: '練習走行に戻る',

    race_modal_title: 'スプリントレース終了',
  ...
  pt: {
    ...
    nav_race_title: 'Corrida Sprint (Grid de 10 Carros)',
    ...
    controls_guide: 'W A S D ou Setas para Pilotar • R Reiniciar • C Câmera • Espaço Freio de Mão',
    ...
    badge_race_grid: 'CORRIDA SPRINT - GRID DE LARGADA',
    badge_race_racing: 'CORRIDA SPRINT',
    ...
    help_key_camera: 'Mudar Câmera (Perseguição / Cockpit / TV)',
    help_key_drs: 'Asa Móvel DRS',
    ...
    quali_btn_race: 'Iniciar Corrida Sprint',
    quali_btn_practice: 'Voltar aos Treinos',

    race_modal_title: 'CORRIDA SPRINT CONCLUÍDA',
