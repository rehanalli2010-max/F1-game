...
async function run() {
  ...
  await send('Runtime.evaluate', {
    expression: `(() => {
      ...
      const track = g.track;
      // Position car slightly before the intersection, approaching at t = 0.435
      const playerT = 0.435;
  ...
  const outPath = 'C:/Users/CHC/.gemini/antigravity-ide/brain/75d6a1f4-5ab9-4fe0-a584-01925a3c23a3/spa_bug_grandstand_in_racetrack.png';
  fs.writeFileSync(outPath, Buffer.from(shot.data, 'base64'));
  console.log('Saved screenshot of Spa grandstand encroachment bug!');
  ws.close();
}
